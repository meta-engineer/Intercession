...
void main()
{
    ...
    vec4 textureDiffuse4 = texture(material.diffuse_map, remappedTexCoord); // use diffuse map for alpha
    ...
    if (material.use_normal_map)
    {
        ...
        norm = texture(material.normal_map, remappedTexCoord).xyz;
    ...
    vec3 textureSpecular= vec3(texture(material.specular_map, remappedTexCoord));
