...
namespace pleep
{
    ...
    void I_ScriptDrivetrain::on_fixed_update(double deltaTime, ScriptComponent& script, Entity entity, Cosmos* owner)
    {
    ...
    void I_ScriptDrivetrain::on_frame_update(double deltaTime, ScriptComponent& script, Entity entity, Cosmos* owner)
    {
        UNREFERENCED_PARAMETER(deltaTime);
        UNREFERENCED_PARAMETER(script);
        UNREFERENCED_PARAMETER(entity);
